...
BUS_ =              TrainInfo("Bus", "🚌", .8, max_delay=10, delay_rate=0.1, max_speed_in_station=(80, 80, 80))
# --- Wagons ---
...
BUS = Train(BUS_, "VT95", "Märklin H0 3016", 62, (0, 1, 25, 55, 80, 100, 120, 140, 150, 160, 170, 180, 190, 200, 210), 40., img_path="Schienenbus.png", stop_by_mm1_reverse=False, functions=(LIGHT,))
...
TRAINS = [ICE, S, SHUTTLE, BUS, E_RB, E_BW, ROT, E40, DIESEL, DAMPF]  # BEIGE
